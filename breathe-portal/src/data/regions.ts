...
export const regionalCaseStudies: RegionalCaseStudy[] = [
  {
    ...
    nasaDataUsed: ["TEMPO hourly NO₂", "MAIA PM2.5", "PACE aerosol type", "MODIS aerosol optical depth"],
  ...
  },
  {
    ...
    nasaDataUsed: ["MAIA PM2.5 and PM10", "PACE dust identification", "MODIS dust detection", "VIIRS aerosol products"],
  ...
  },
  {
    ...
    nasaDataUsed: ["MODIS/VIIRS fire and smoke", "TEMPO pollution monitoring", "MAIA PM2.5", "PACE smoke aerosol characterization"],
