...
const educatorResources = [
  {
    ...
    items: [
      ...
      { title: "Aerosol Detective — PACE Pollution Source Identification (Grades 9-12)", format: "PDF", pages: 20 },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Exploring PACE Aerosol Type Maps — Teacher Guide", format: "PDF", pages: 10 },
